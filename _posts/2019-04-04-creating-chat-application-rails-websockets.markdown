...
Open `app/views/layouts/application.html.erb` and change the following lines:
...
**Note:** We construct a new room message which we are going to use in the view to build a form for creating the chat messages.
...
Replace the contents of `app/assets/views/rooms/show.html.erb` with:
